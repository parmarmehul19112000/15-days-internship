...
if($_POST){
	...
	$pquery=mysqli_query($connection,"insert into tbl_product(pro_name,pro_price,pro_detail) values ('{$pname}','{$pprice}','{$pdetail}')") or die(mysqli_error($connection));
								 ...
								 <label for="inputEmail3" class="col-sm-2 control-label">Product Name</label>
								  ...
								  <input type="text" class="form-control" id="inputEmail3" name="pname" placeholder="Enter Product Name" required> </div> </div>
								   ...
								   <label for="inputPassword3" class="col-sm-2 control-label">Product Price</label>
								    <div class="col-sm-9"> 
									<input type="text" class="form-control" id="inputPassword3" name="pprice" placeholder="Enter Product Price" required> </div> </div>
