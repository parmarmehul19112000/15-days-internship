...
<body class="cbp-spmenu-push">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					...
					<a href='add-product.php'>	<h4>Product Detail Add:</h4></a>
						<table class="table">
							<thead>
								<tr>
								  <th>#</th>
    ...
    while($productrow=mysqli_fetch_array($selectq)){
        ...
        echo "<td><a href='edit-product.php?eid={$productrow['pro_id']}'><img style='width: 16px;' src='./myimage/edit.png'>Edit</a> | <a href='display-product.php?did={$productrow['pro_id']}'><img style='width: 16px;' src='./myimage/delete.png'>Delete</a></td>";
        echo "</tr>";
    }
                            ?>
