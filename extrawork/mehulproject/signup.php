...
if($_POST){
	...
	$pquery=mysqli_query($connection,"insert into signup(firstname,lastname,email,gender,password) values ('{$firstname}','{$lastname}','{$email}','{$gender}','{$password}')") or die(mysqli_error($connection));
}
?>
